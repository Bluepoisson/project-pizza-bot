...
if (validateOrderName(orderName())) {
  ...
  alert(
    `Great, I'll get started on your ${orderName()}s right away, it will cost ${calculateOrderTotal(
      orderQuantity,
      pizzaPrice
    )} kr.`
  );
...
document.getElementById(
  "orderSummary"
).innerHTML = `<h2>Thank you for your order!</h2> The ${orderName()}s are being
